...
public class SeethRenderer extends GeoEntityRenderer<SeethEntity> {
    private static final ResourceLocation SEETH_BEAM_LOCATION = new ResourceLocation(CulinaryCultists.MOD_ID, "textures/entity/seeth_beam.png");
    private static final RenderType BEAM_RENDER_TYPE = RenderType.entityCutoutNoCull(SEETH_BEAM_LOCATION);

    public SeethRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SeethModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public ResourceLocation getTextureLocation(SeethEntity instance) {
        return new ResourceLocation(CulinaryCultists.MOD_ID, "textures/entity/seeth_texture.png");
    }

    @Override
    public RenderType getRenderType(SeethEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
        return super.getRenderType(animatable, texture, bufferSource, partialTick);
    }

    public boolean shouldRender(SeethEntity pLivingEntity, Frustum pCamera, double pCamX, double pCamY, double pCamZ) {
    ...
    public void render(SeethEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
